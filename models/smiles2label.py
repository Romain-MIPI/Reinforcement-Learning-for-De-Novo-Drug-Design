# Modified from
# https://github.com/Mariewelt/OpenChem/blob/master/openchem/models/openchem_model.py
...
class Smiles2Label(nn.Module):
    def __init__(self, params):
        super(Smiles2Label, self).__init__()
...
def evaluate(model, data_loader, criterion=None, average=None, epoch=None):
    ...
    if eval_metrics == balanced_accuracy_score:
        metrics = eval_metrics(ground_truth, prediction)
    else:
        metrics = eval_metrics(ground_truth, prediction, average=average)
